...
const DEFAULT_PROMPT =
  '把 profile 保存成 JSON，内容是 {"name":"Wesley","city":"Shanghai"}。';
const SYSTEM_PROMPT = [
  "你是一个简洁的浏览器助手。",
    ...
    <main className="minimal-shell">
      <section className="minimal-frame">
        <div
          ...
          aria-live="polite"
          onScroll={() =>
            handleChatLogScroll(chatLogRef, shouldStickToBottomRef)
          }
        >
          {transcript.map((message, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="minimal-bubble-body">
        ...
        <footer className="minimal-composer">
          {errorMessage ? (
            <p className="minimal-error">{errorMessage}</p>
          ) : null}
          <textarea
          ...
          <div className="minimal-action-row">
            ...
            <button
              ...
              disabled={!OPENAI_KEY || !isReady || isStreaming}
            >
              新会话
            </button>
            <button
