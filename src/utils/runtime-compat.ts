...
export function resolveFetchImplementation(fetchImpl?: typeof globalThis.fetch): typeof globalThis.fetch {
  if (fetchImpl) {
    return fetchImpl;
  }
  ...
  throw new Error("No fetch implementation is available. Pass fetch explicitly in this environment.");
}